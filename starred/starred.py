...
> A curated list of my GitHub stars! Generated by [starred](https://github.com/bormaxi8080/starred). All tools, programs and techniques published in this article and repository are used for informational, educational purposes or for information security purposes. The authors are not responsible for the activities that users of these tools and techniques may carry out, and urge them not to use them to carry out harmful or destructive activities directed against other users or groups on the Internet.
...
def starred(username, token, sort, topic, repository, filename, message, private, topic_limit):
    ...
    example:
        starred --username bormaxi8080 --token=xxxxxxxx --sort > README.md
    """
