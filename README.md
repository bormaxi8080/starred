...
- [pbek/usb_hid_autofire](https://github.com/pbek/usb_hid_autofire) - Simple Flipper Zero application to send left-clicks as a USB HID device
...
- [mochabyte0x/Orion](https://github.com/mochabyte0x/Orion) - Orion is a TCP/IP Forensics Tool, written in C, capable of detecting malicious processes / connections on windows hosts by using the VirusTotal API.
- [mochabyte0x/CTFPacker](https://github.com/mochabyte0x/CTFPacker) - Cross platform (Linux / Windows) shellcode packer for CTFs and pentest / red team exams aiming for AV evasion !
...
- [Hong5489/ir_remote](https://github.com/Hong5489/ir_remote) - Alternative Infrared Remote plugin for FlipperZero
- [shaddy43/BrowserSnatch](https://github.com/shaddy43/BrowserSnatch) - BrowserSnatch is a powerful browser stealer or browser data extraction tool intended to be used for ethical hacking or penetration testing.
...
- [llem00n/brofile](https://github.com/llem00n/brofile) - Brofile is a utility app which grants you with a better link handling abilities (works on my machine)
...
- [Ravikisha/RelaxSearch](https://github.com/Ravikisha/RelaxSearch) - RelaxSearch is a lightweight, demonstration-based search engine project built with Go and Elasticsearch.
- [Librum-Reader/Librum](https://github.com/Librum-Reader/Librum) - The Librum client application
- [CapibaraZero/fw](https://github.com/CapibaraZero/fw) - CapibaraZero main firmware repository
...
- [flipperdevices/flipperzero-documentation](https://github.com/flipperdevices/flipperzero-documentation) - 
...
- [rdx40/gmail-tui](https://github.com/rdx40/gmail-tui) - gmail but in your terminal using go
- [Hanashiko/apimocker](https://github.com/Hanashiko/apimocker) - 
- [stopcenz/fakesni](https://github.com/stopcenz/fakesni) - Программа для обхода блокировок путем модификации заголовков протокола TLS.
...
- [ispringtech/brewkit](https://github.com/ispringtech/brewkit) - Container-native build system
- [puzed/wrapguard](https://github.com/puzed/wrapguard) - Userspace WireGuard proxy for transparent network tunneling
...
- [machbase/neo-server](https://github.com/machbase/neo-server) - machbase-neo = time series database + mqtt + http + data visualization
...
- [darwishdev/sqlseeder](https://github.com/darwishdev/sqlseeder) - 
...
- [akkik04/Trace](https://github.com/akkik04/Trace) - POC for a real-time log monitoring solution, orchestrated as a distributed system
...
- [0xHasanM/LogonSessionAuditor](https://github.com/0xHasanM/LogonSessionAuditor) - This tool parses Windows EVTX logs to extract login and logout sessions from a security.evtx file. It uses a Tkinter GUI to let you select the EVTX file and specify a time for correlating login and lo
- [curiousqeorqe/FlipperZeroDB](https://github.com/curiousqeorqe/FlipperZeroDB) - All In One Flipper Zero Database
- [DarkWebInformer/darknetlive](https://github.com/DarkWebInformer/darknetlive) - A web scrape of Darknetlive. Incognito Market admin has removed the news page. This scrape has everything including the news.
...
- [tegridydev/python-OSINT-notebook](https://github.com/tegridydev/python-OSINT-notebook) - a rough written "guide" compiled from years of ADHD brain notes - enjoy
- [29fulcrum/DiscordOSINT](https://github.com/29fulcrum/DiscordOSINT) - 
...
- [testdriverai/cli](https://github.com/testdriverai/cli) - Next generation autonomous AI agent for end-to-end testing of web & desktop
...
- [manjurulhoque/wowy](https://github.com/manjurulhoque/wowy) - WOWY is a modern, full-featured e-commerce platform built with Django 4.x, designed to provide a seamless shopping experience for both customers and administrators. This comprehensive solution offers 
...
- [passthesh3ll/The-Pika-s-OSINT-ToolBox](https://github.com/passthesh3ll/The-Pika-s-OSINT-ToolBox) - Yet another OSINT tools list 🕵️‍♂️
...
- [paulpogoda/OSINT-Tools-Saudi-Arabia](https://github.com/paulpogoda/OSINT-Tools-Saudi-Arabia) - A list of OSINT resources and tools that may be useful when conducting investigations related to the Kingdom of Saudi Arabia
- [paulpogoda/OSINT-Tools-Belarus](https://github.com/paulpogoda/OSINT-Tools-Belarus) - A list of OSINT resources and tools that may be useful to you when conducting investigations related to the Republic of Belarus
- [jimilinuxguy/flipperzero-lrs-pagers](https://github.com/jimilinuxguy/flipperzero-lrs-pagers) - FlipperZero Brute for of LRS Pager System
- [msadowski/awesome-weekly-robotics](https://github.com/msadowski/awesome-weekly-robotics) - A list of projects that were or will be featured in Weekly Robotics newsletter
...
- [cr0nx/awesome-linux-attack-forensics-purplelabs](https://github.com/cr0nx/awesome-linux-attack-forensics-purplelabs) - This page is a result of the ongoing hands-on research around advanced Linux attacks, detection and forensics techniques and tools.
...
- [paulpogoda/OSINT-Tools-Netherlands](https://github.com/paulpogoda/OSINT-Tools-Netherlands) - List of Dutch OSINT Sources for profilers and fact-checkers
- [paulpogoda/OSINT-Tools-China](https://github.com/paulpogoda/OSINT-Tools-China) - A list of OSINT tools and resources for profilers and fact-checkers
...
- [paulpogoda/OSINT-for-countries-V2.0](https://github.com/paulpogoda/OSINT-for-countries-V2.0) - OSINT resources and tools by country, structured for fact-checkers and digital profilers
- [paulpogoda/OSINT-Tools-Australia](https://github.com/paulpogoda/OSINT-Tools-Australia) - A list of OSINT resources tools that may be useful to you when conducting investigations related to Australia
- [paulpogoda/OSINT-Tools-Israel](https://github.com/paulpogoda/OSINT-Tools-Israel) - Websites and tools for OSINT investigations pertaining to Israel
- [paulpogoda/OSINT-Tools-Bulgaria](https://github.com/paulpogoda/OSINT-Tools-Bulgaria) - Bulgarian OSINT tools list.
- [paulpogoda/OSINT-Tools-Russia](https://github.com/paulpogoda/OSINT-Tools-Russia) - A list of OSINT tools that may be useful to you when conducting investigations related to Russian Federation
- [paulpogoda/OSINT-Tools-Emirates](https://github.com/paulpogoda/OSINT-Tools-Emirates) - Tools for OSINT in Emirates
...
- [ropcat/reversing-unofficial-APIs](https://github.com/ropcat/reversing-unofficial-APIs) - Resources for reverse engineering “unofficial APIs”.
...
- [beigeworm/BadUSB-Files-For-FlipperZero](https://github.com/beigeworm/BadUSB-Files-For-FlipperZero) - A Collection of Over 60 Scripts - updated specifically for the BadUSB function on the FlipperZero.
...
- [navig-me/telert](https://github.com/navig-me/telert) - Command‑line and Python utility that alerts on command completion, code execution and system monitoring events
...
- [RuinasHistori/BotCommander](https://github.com/RuinasHistori/BotCommander) - 🚀 BotCommander — это простой и удобный веб-интерфейс для управления множеством Python-ботов
...
- [kliakhnovich/smmr](https://github.com/kliakhnovich/smmr) - 
...
- [pie0902/reTermAI](https://github.com/pie0902/reTermAI) - 
...
- [martinn/quickapiclient](https://github.com/martinn/quickapiclient) - Create fully typed declarative API clients quickly and easily.
- [daijro/manga-dl](https://github.com/daijro/manga-dl) - manganelo scraper
...
- [Efeckc17/YoutubeGO](https://github.com/Efeckc17/YoutubeGO) - YouTubeGO is a high-performance video/audio downloader supporting major platforms like YouTube, Vimeo, Odysee, TikTok, SoundCloud, and Twitter. With MP3/MP4 support, smart queueing, batch tools, sched
...
- [ParrotCoder1/alfredtest](https://github.com/ParrotCoder1/alfredtest) - Alfred is a advanced OSINT information gathering tool
- [Abdulbluebird/alfred](https://github.com/Abdulbluebird/alfred) - Alfred is a advanced OSINT information gathering tool that finds social media accounts based on inputs.
- [yel1337/Mellisa](https://github.com/yel1337/Mellisa) - Web Parameter Crawling Tool
- [subzeroid/aiograpi](https://github.com/subzeroid/aiograpi) - 🔥 Asynchronous Python library for Instagram Private API 2025
...
- [stephentu/fbsh](https://github.com/stephentu/fbsh) - Facebook on the command line
...
- [rennf93/fastapi-guard](https://github.com/rennf93/fastapi-guard) - A security library for FastAPI that provides middleware to control IPs, log requests, and detect penetration attempts. It integrates seamlessly with FastAPI to offer robust protection against various 
- [fsspec/filesystem_spec](https://github.com/fsspec/filesystem_spec) - A specification that python filesystems should adhere to.
- [whxitte/white-obfuscate](https://github.com/whxitte/white-obfuscate) - This is a tool to obfuscate / to make your python code unreadable. It obfuscates your code and prevents easy access of others to your code.
- [gaspa93/googlemaps-scraper](https://github.com/gaspa93/googlemaps-scraper) - Google Maps reviews scraping
- [h1w/photo-video-watermark](https://github.com/h1w/photo-video-watermark) - Telegram bot for creating watermark on photos and videos.
- [seleniumbase/SeleniumBase](https://github.com/seleniumbase/SeleniumBase) - Python APIs for web automation, testing, and bypassing bot-detection.
- [dagowda/DSViper](https://github.com/dagowda/DSViper) - This is for Ethical Use only.
- [aviaryan/voice-transcribe-summarize-telegram-bot](https://github.com/aviaryan/voice-transcribe-summarize-telegram-bot) - Telegram bot to generate transcriptions and summarise voice notes
...
- [andersonsevla/OsintIA_Tools](https://github.com/andersonsevla/OsintIA_Tools) - OsintIA_Tools.py is an automated tool for collecting and analyzing public information that combines OSINT techniques with artificial intelligence, providing detailed insights into cybersecurity, poten
- [amanvirparhar/chaplin](https://github.com/amanvirparhar/chaplin) - A real-time silent speech recognition tool.
- [merwin-asm/StegaShade](https://github.com/merwin-asm/StegaShade) - Stega Shade CLI is a user-friendly command-line interface tool designed for image-based steganography. With a focus on simplicity and security, it provides functionality to encode and decode messages 
...
- [ranahaani/autogram](https://github.com/ranahaani/autogram) - AI agent that automates AI news curation and post to Instagram using gpt-image-1
- [uav4geo/GeoDeep](https://github.com/uav4geo/GeoDeep) - Free and open source library for AI object detection and semantic segmentation in geospatial rasters. 🚀
...
- [ad-si/Perspectra](https://github.com/ad-si/Perspectra) - Automatically extract documents from images and perspectively correct them with classic computer-vision algorithms. Check out Perspec for a GUI alternative.
...
- [DarkWebInformer/FBI_Watchdog](https://github.com/DarkWebInformer/FBI_Watchdog) - FBI Watchdog is an OSINT tool that monitors domain seizures and DNS record changes in real time, alerting users to law enforcement takedowns and other DNS modifications.
- [DarkWebInformer/company-revenue-lookup](https://github.com/DarkWebInformer/company-revenue-lookup) - Lookup a company's revenue via stock ticker
...
- [samwit/agent_tutorials](https://github.com/samwit/agent_tutorials) - various agent tutorials
...
- [Clats97/ClatsCracker](https://github.com/Clats97/ClatsCracker) - ClatsCracker is a versatile Executable & Python based password-cracking tool supporting 25 hash algorithms. It offers dictionary or brute-force attacks, adjustable threads, salted hash verification, a
...
- [drego85/meioc](https://github.com/drego85/meioc) - Extracting IoC data from eMail
- [FlareSolverr/FlareSolverr](https://github.com/FlareSolverr/FlareSolverr) - Proxy server to bypass Cloudflare protection
- [PShlyundin/GPOHunter](https://github.com/PShlyundin/GPOHunter) - A security assessment tool for analyzing Active Directory Group Policy Objects (GPOs) to identify misconfigurations and vulnerabilities
- [sharsil/favicorn](https://github.com/sharsil/favicorn) - All-sources tool to search websites by favicons
- [getzep/graphiti](https://github.com/getzep/graphiti) - Build Real-Time Knowledge Graphs for AI Agents
- [NVIDIA/garak](https://github.com/NVIDIA/garak) - the LLM vulnerability scanner
- [Hamed233/Digital-Footprint-OSINT-Tool](https://github.com/Hamed233/Digital-Footprint-OSINT-Tool) - A powerful Open Source Intelligence (OSINT) tool for analyzing digital footprints across multiple platforms. This tool helps researchers and security professionals map an individual's online presence 
...
- [RetrO-M/Hawker](https://github.com/RetrO-M/Hawker) - If you are having trouble with your investigations, Hawker OSINT is here to help.
...
- [SocialLinks-IO/sociallinks-api](https://github.com/SocialLinks-IO/sociallinks-api) - Social Links API: description, examples, trial access
...
- [Spix0r/writeup-miner](https://github.com/Spix0r/writeup-miner) - This is a useful Python script for extracting bug bounty or any other write-ups from every RSS.
- [wifiphisher/wifiphisher](https://github.com/wifiphisher/wifiphisher) - The Rogue Access Point Framework
- [otaha178/Emotion-recognition](https://github.com/otaha178/Emotion-recognition) - Real time emotion recognition
...
- [diegovelilla/FreeThinker](https://github.com/diegovelilla/FreeThinker) - FreeThinker is an AI agent that uses free-of-charge API open source LLMs in order to automatize tasks. That meaning that you don't required pay-per-token API keys to run it.
- [LOUDO56/PyMacroRecord](https://github.com/LOUDO56/PyMacroRecord) - Free and Open Source Macro Recorder with a modern GUI using Python
...
- [jeppbautista/tiktok-crawler](https://github.com/jeppbautista/tiktok-crawler) - A custom Python crawler written in Selenium for downloading Tiktok videos as mp4 files along with their metadata in a json file (author, tags, captions, etc.).
...
- [estebanpdl/tik-spyder](https://github.com/estebanpdl/tik-spyder) - A Python command-line tool designed to collect TikTok data using SerpAPI for Google search results and Apify for TikTok data extraction.
- [krakodjaba/TelAnalysis](https://github.com/krakodjaba/TelAnalysis) - TelAnalysis - Telegram Analysis tool
- [mochabyte0x/Elyzer](https://github.com/mochabyte0x/Elyzer) - Elyzer is an email header analyzer, written in python, capable of detecting potential spoofing attempts.
...
- [cc-d/open2fa](https://github.com/cc-d/open2fa) - A 2FA CLI tool for generating 2FA codes using TOTP secrets, and an optional web ui enabling 2FA code generation from any device
...
- [claromes/waybacktweets](https://github.com/claromes/waybacktweets) - Archived tweets from the Wayback Machine
...
- [anmolksachan/ThreatTracer](https://github.com/anmolksachan/ThreatTracer) - ThreatTracer - A python Script to identify CVE by name & version and more by @FR13ND0x7F
...
- [chm0dx/leakyBuckets](https://github.com/chm0dx/leakyBuckets) - Find open storage buckets and accessible files across Amazon Web Services, Google Cloud, Microsoft Azure, and Digital Ocean simultaneously
...
- [aels/mailtools](https://github.com/aels/mailtools) - Perfect scripts for all the hustle we have with mass-mailing
...
- [fin3ss3g0d/cypherhound](https://github.com/fin3ss3g0d/cypherhound) - Your template-based BloodHound terminal companion tool
...
- [AstraaDev/Discord-Token-Grabber](https://github.com/AstraaDev/Discord-Token-Grabber) - Collect Discord tokens and user information by scanning local storage files from various browser applications and extensions
...
- [flipperzero-rs/flipperzero-rs](https://github.com/flipperzero-rs/flipperzero-rs) - Rust on the Flipper Zero
...
- [M4xSec/K-OTP-X](https://github.com/M4xSec/K-OTP-X) - Advance OTP Bypass Tool. Termux Supported.
...
- [808ale/Linux_QuickEnum](https://github.com/808ale/Linux_QuickEnum) - QuickEnum is a tool designed to help with privilege escalation on Linux systems
- [808ale/ExploitationBundle](https://github.com/808ale/ExploitationBundle) - Bash script that automates the downloading of various exploitation tools.
- [808ale/dirspider](https://github.com/808ale/dirspider) - Bash script automating directory brute forcing and crawling/spider.
...
- [blackhatethicalhacking/SQLMutant](https://github.com/blackhatethicalhacking/SQLMutant) - SQLMutant is a powerful SQL injection testing tool that includes both passive and active reconnaissance processes for any given domain. It filters URLs to identify those with parameters susceptible to
...
- [wellrodrig/Whatsapp-Spy](https://github.com/wellrodrig/Whatsapp-Spy) - WhatsApp Spy is an app designed to monitor and log all on-screen texts whenever a user opens WhatsApp / Whatsapp Business. It also supports Instagram and Messenger, sending logs to either Discord or T
...
- [SpoofDPIApp/SpoofDPI-App](https://github.com/SpoofDPIApp/SpoofDPI-App) - Простое в использовании приложение для Mac, благодаря которому YouTube снова заработает отлично! На основе библиотеки SpoofDPI.
...
- [azat-io/token-limit](https://github.com/azat-io/token-limit) - 🛰 Monitor how many tokens your code and configs consume in AI tools. Set budgets and get alerts when limits are hit
...
- [3kh0/filehunt](https://github.com/3kh0/filehunt) - Search query builder for finding sensitive files on the web
...
- [ddoemonn/parrot_ui](https://github.com/ddoemonn/parrot_ui) - A beautiful React component library built specifically for Next.js App Router
- [kexa-io/Kexa](https://github.com/kexa-io/Kexa) - Kexa's simple rules (Open Source) make it easy to monitoring and manage alerting of your entire cloud. With various monitoring and alerting options, instant and detailed alerts, easy-to-deploy and low
