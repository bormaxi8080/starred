...
- [topscoder/nuclei-wordfence-cve](https://github.com/topscoder/nuclei-wordfence-cve) - You just found a hidden gem 💎 This repo contains a massive amount (8000+) of WordPress related Nuclei templates. Updated daily!
...
- [HalilDeniz/TrafficWatch](https://github.com/HalilDeniz/TrafficWatch) - TrafficWatch, a packet sniffer tool, allows you to monitor and analyze network traffic from PCAP files. It provides insights into various network protocols and can help with network troubleshooting, s
...
- [ronin-dojo/Pinkerton2](https://github.com/ronin-dojo/Pinkerton2) - 🕵️ Pinkerton is an JavaScript file crawler and secret finder tool developed in Python
...
- [curosim/facebook-leak-search](https://github.com/curosim/facebook-leak-search) - There's a useful hidden service to search through the Facebook 2021 Data Leak. This is the Python wrapper to query the hidden service.
...
- [atenreiro/opensquat](https://github.com/atenreiro/opensquat) - The openSquat project is an open-source solution for detecting phishing domains and domain squatting. It searches for newly registered domains that impersonate legitimate domains on a daily basis.
...
- [ninoseki/eml_analyzer](https://github.com/ninoseki/eml_analyzer) - EML analyzer is an application to analyze the EML file
...
- [ninoseki/miteru](https://github.com/ninoseki/miteru) - An experimental phishing kit detection tool
...
- [pisoj/torsh](https://github.com/pisoj/torsh) - Create a reverse shell over Tor network without port forwarding and with improved anonymity.
